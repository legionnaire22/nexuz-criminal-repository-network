...
export const getFullGraphTopology = (caseId) => {
  if (caseId === "sandstorm") {
    return [
      ...
      { data: { id: "e1", source: "P001", target: "ACC001", rel_type: "CONTROLS_ACCOUNT", weight: 4.5, color: "#ff2a55", doc: "txn_sandstorm.csv", metric: "Signatory Authority", reason: "Direct signatory control and beneficiary authority over HDFC account." } },
      { data: { id: "e2", source: "ACC001", target: "ORG001", rel_type: "PMLA_SMURFING", weight: 4.5, color: "#ff2a55", doc: "txn_sandstorm.csv", metric: "10x ₹9.80L Deposits", reason: "ANO-002: 10 structured transfers under ₹10L threshold routed into corporate shell account." } },
      { data: { id: "e3", source: "P001", target: "PH001", rel_type: "SUBSCRIBER_OF", weight: 3, color: "#00f0ff", doc: "cdr_sandstorm.csv", metric: "MSISDN Match", reason: "Telecom registration and CDR tower logs confirm active ownership of +91-98400-11111." } },
      { data: { id: "e4", source: "PH001", target: "PH002", rel_type: "CDR_BURST_CALLS", weight: 4.5, color: "#ffb800", doc: "cdr_sandstorm.csv", metric: "18 Calls in 48h", reason: "ANO-001: Abnormal spike of 18 phone calls immediately preceding the narcotics delivery." } },
      { data: { id: "e5", source: "PH002", target: "P002", rel_type: "USED_BY", weight: 3, color: "#00f0ff", doc: "fir_sandstorm_1.txt", metric: "Device Seized", reason: "Burner phone recovered directly from Kabir Sheikh upon apprehension." } },
      { data: { id: "e6", source: "P002", target: "P003", rel_type: "CO_ACCUSED", weight: 3, color: "#ff7b95", doc: "fir_sandstorm_2.txt", metric: "Named Jointly", reason: "Jointly indicted under NDPS Sections 22 & 29 in FIR #0312." } },
      { data: { id: "e7", source: "P005", target: "ORG001", rel_type: "DIRECTOR_OF", weight: 3, color: "#a855f7", doc: "fir_sandstorm_3.txt", metric: "MCA21 Registry", reason: "Official corporate filings list Anand Krishnan as statutory director of Phoenix Exports." } },
      { data: { id: "e8", source: "P004", target: "PH002", rel_type: "DISPENSED_SIM", weight: 2.5, color: "#a855f7", doc: "fir_sandstorm_3.txt", metric: "Retailer Point-of-Sale", reason: "Prepaid SIM card activated at Vikram Sinha's telecom outlet without Aadhaar validation." } },
      { data: { id: "e9", source: "P004", target: "PH003", rel_type: "DISPENSED_SIM", weight: 2.5, color: "#a855f7", doc: "fir_sandstorm_3.txt", metric: "Burner Pool", reason: "Secondary burner SIM activated using forged customer application form." } },
      { data: { id: "e10", source: "P003", target: "PH003", rel_type: "CARRIED_DEVICE", weight: 2.5, color: "#00f0ff", doc: "fir_sandstorm_2.txt", metric: "Active Device", reason: "Handset located in possession of courier Deepak Rao." } },
      { data: { id: "e11", source: "P001", target: "TOW001", rel_type: "TOWER_PING", weight: 3, color: "#ffb800", doc: "cdr_sandstorm.csv", metric: "Co-located", reason: "Tower BKC-112 recorded subscriber connection during raid prep." } },
      { data: { id: "e12", source: "P002", target: "TOW001", rel_type: "TOWER_PING", weight: 3, color: "#ffb800", doc: "cdr_sandstorm.csv", metric: "Co-located", reason: "Concurrent cell tower registration verifying rendezvous." } },
      { data: { id: "e13", source: "P003", target: "ACC002", rel_type: "OPERATES_MULE", weight: 3, color: "#ff2a55", doc: "txn_sandstorm.csv", metric: "Mule Cashier", reason: "Cash withdrawals executed immediately upon receipt of transfers." } },
      { data: { id: "e14", source: "ORG001", target: "ACC003", rel_type: "TRANSFERS_TO", weight: 3.5, color: "#ff2a55", doc: "txn_sandstorm.csv", metric: "Layering Flight", reason: "Inter-company transfers obfuscating provenance of illicit funds." } },
      { data: { id: "e15", source: "P002", target: "VEH001", rel_type: "DISPATCHED", weight: 3, color: "#ff2a55", doc: "fir_sandstorm_1.txt", metric: "Vehicle Escort", reason: "Kabir Sheikh coordinated driver itinerary for seized van." } },
      { data: { id: "e16", source: "VEH001", target: "LOC001", rel_type: "TRACKED_AT", weight: 3, color: "#00f0ff", doc: "fir_sandstorm_2.txt", metric: "GPS Geo-fence", reason: "Vehicle telematics show entry into Nhava Sheva CFS container dock." } },
      { data: { id: "e17", source: "ORG002", target: "LOC001", rel_type: "CONSIGNEE_AT", weight: 2, color: "#94a3b8", doc: "fir_sandstorm_2.txt", metric: "Bill of Lading", reason: "Freight handler listed on customs clearing documentation." } },
    ...
    return [
      ...
      // === Verified Criminal Syndicate Edges ===
      { data: { id: "e10", source: "Q001", target: "ORG003", rel_type: "CONTROLS", weight: 4, color: "#ff2a55", doc: "fir_phantom_1.txt", metric: "Executive", reason: "Directs operational extortion activities." } },
      { data: { id: "e11", source: "ORG003", target: "ACC_DELTA", rel_type: "BANK_ACCOUNT", weight: 3, color: "#ff2a55", doc: "txn_phantom.csv", metric: "Collection Account", reason: "Primary bank account receiving coercive remittances." } },
      { data: { id: "e12", source: "Q001", target: "Q002", rel_type: "SUPERVISES", weight: 3, color: "#ff2a55", doc: "fir_phantom_1.txt", metric: "Direct Enforcer", reason: "Dispatched Ravi Kumar to conduct on-site physical intimidation." } },
      { data: { id: "e19", source: "Q007", target: "ORG005", rel_type: "CONTROLS_ENTITY", weight: 3.5, color: "#ff2a55", doc: "fir_phantom_2.txt", metric: "Sole Proprietor", reason: "Controls Jain Bullion Traders off-ramp." } },
      { data: { id: "e20", source: "ACC_ROHIT", target: "ORG005", rel_type: "BULLION_PURCHASE", weight: 4, color: "#ff2a55", doc: "txn_phantom.csv", metric: "Gold Off-Ramp", reason: "Converted illicit funds into 2.8 kg untraced gold bars." } },
      { data: { id: "e21", source: "Q007", target: "Q008", rel_type: "BULLION_CONSIGNMENT", weight: 3, color: "#ff2a55", doc: "fir_phantom_2.txt", metric: "Cashier Pickup", reason: "Amitabh Shah executed physical bullion pickup." } },
    ...
    return [
      ...
      { data: { id: "e20", source: "M002", target: "STORE_01", rel_type: "OPERATES_COUNTER", weight: 3, color: "#ff2a55", doc: "fir_mirage_2.txt", metric: "Telecom Franchise", reason: "Prakash Desai managed POS terminal dispensing replacement SIM." } },
      { data: { id: "e21", source: "M002", target: "PH_VIC", rel_type: "FRAUDULENT_SWAP", weight: 4.5, color: "#ff2a55", doc: "fir_mirage_2.txt", metric: "SIM Swap Action", reason: "Cloned victim number without biometric authentication." } },
      { data: { id: "e22", source: "M002", target: "TOW001", rel_type: "CO_LOCATED_AT", weight: 3.5, color: "#ff2a55", doc: "cdr_mirage.csv", metric: "29-Apr 22:30", reason: "ANO-007: Spatial graph co-occurrence during planning window." } },
      { data: { id: "e23", source: "M001", target: "TOW001", rel_type: "CO_LOCATED_AT", weight: 3.5, color: "#ff2a55", doc: "cdr_mirage.csv", metric: "29-Apr 22:30", reason: "ANO-007: Multiple suspect SIMs co-located at same cell tower." } },
      { data: { id: "e24", source: "M004", target: "M001", rel_type: "CREDENTIAL_LEAK", weight: 3.5, color: "#a855f7", doc: "fir_mirage_1.txt", metric: "Dark Web Lead", reason: "Transferred victim bank user ID and target phone data." } },
      { data: { id: "e25", source: "PH_VIC", target: "M001", rel_type: "OTP_FORWARD", weight: 4.5, color: "#ffb800", doc: "cdr_mirage.csv", metric: "Intercepted OTP", reason: "Cloned SIM received net-banking OTPs at 02:13 AM." } },
      { data: { id: "e26", source: "M001", target: "ACC_M01", rel_type: "DRAIN_FUNDS", weight: 4.5, color: "#ff2a55", doc: "txn_mirage.csv", metric: "₹4,50,000 Transferred", reason: "ANO-006: Night-time high-velocity siphon to mule account 1." } },
      { data: { id: "e27", source: "M001", target: "ACC_M02", rel_type: "DRAIN_FUNDS", weight: 4.5, color: "#ff2a55", doc: "txn_mirage.csv", metric: "₹4,50,000 Transferred", reason: "ANO-006: Night-time siphon to mule account 2." } },
      { data: { id: "e28", source: "M003", target: "ACC_M01", rel_type: "CONTROLS_CARD", weight: 3, color: "#ff2a55", doc: "fir_mirage_3.txt", metric: "Debit Card Mule", reason: "Possessed ATM debit card mapped to mule account 1." } },
      { data: { id: "e29", source: "M003", target: "ATM_01", rel_type: "CASH_WITHDRAWAL", weight: 4, color: "#ff2a55", doc: "txn_mirage.csv", metric: "₹1,50,000 Cash", reason: "Night ATM CCTV footage captures physical cash drain." } },
      { data: { id: "e30", source: "M003", target: "ATM_02", rel_type: "CASH_WITHDRAWAL", weight: 3.5, color: "#ff2a55", doc: "txn_mirage.csv", metric: "₹1,00,000 Cash", reason: "Second ATM cash extraction at Kurla station." } },
      { data: { id: "e31", source: "ACC_M02", target: "CRYPTO_01", rel_type: "P2P_PURCHASE", weight: 4, color: "#ff2a55", doc: "txn_mirage.csv", metric: "USDT Escrow", reason: "Converted ₹4,50,000 into offshore crypto stablecoins." } },
      { data: { id: "e32", source: "M003", target: "TOW004", rel_type: "TOWER_REGISTRATION", weight: 2.5, color: "#ffb800", doc: "cdr_mirage.csv", metric: "03:15 AM Ping", reason: "Cellular ping co-occurring with Kurla ATM withdrawal." } },
